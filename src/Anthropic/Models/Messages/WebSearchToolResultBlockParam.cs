...
public sealed record class WebSearchToolResultBlockParam : JsonModel
{
    ...
    public WebSearchToolResultBlockParamCaller? Caller
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<WebSearchToolResultBlockParamCaller>("caller");
        }
        init
        {
            if (value == null)
...
public record class WebSearchToolResultBlockParamCaller : ModelBase
{
    ...
    public WebSearchToolResultBlockParamCaller(DirectCaller value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public WebSearchToolResultBlockParamCaller(ServerToolCaller value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public WebSearchToolResultBlockParamCaller(
    ...
    public WebSearchToolResultBlockParamCaller(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of WebSearchToolResultBlockParamCaller"
                );
        }
    }
    ...
    public static implicit operator WebSearchToolResultBlockParamCaller(DirectCaller value) =>
        new(value);

    public static implicit operator WebSearchToolResultBlockParamCaller(ServerToolCaller value) =>
        new(value);

    public static implicit operator WebSearchToolResultBlockParamCaller(
        ServerToolCaller20260120 value
    ) => new(value);
    ...
    public virtual bool Equals(WebSearchToolResultBlockParamCaller? other) =>
        other != null
...
sealed class WebSearchToolResultBlockParamCallerConverter
    : JsonConverter<WebSearchToolResultBlockParamCaller>
{
    public override WebSearchToolResultBlockParamCaller? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new WebSearchToolResultBlockParamCaller(element);
            }
        }
    }
