...
/// </summary>
public record class DeploymentUnpauseParams : ParamsBase
{
    ...
    public DeploymentUnpauseParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DeploymentUnpauseParams(DeploymentUnpauseParams deploymentUnpauseParams)
        : base(deploymentUnpauseParams)
    {
        this.DeploymentID = deploymentUnpauseParams.DeploymentID;
    }
...
#pragma warning restore CS8618
    ...
    public static DeploymentUnpauseParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string deploymentID
    )
    ...
    public virtual bool Equals(DeploymentUnpauseParams? other)
    {
        if (other == null)
        {
            return false;
