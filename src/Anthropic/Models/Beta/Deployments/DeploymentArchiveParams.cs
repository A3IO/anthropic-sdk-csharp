...
/// </summary>
public record class DeploymentArchiveParams : ParamsBase
{
    ...
    public DeploymentArchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DeploymentArchiveParams(DeploymentArchiveParams deploymentArchiveParams)
        : base(deploymentArchiveParams)
    {
        this.DeploymentID = deploymentArchiveParams.DeploymentID;
    }
...
#pragma warning restore CS8618
    ...
    public static DeploymentArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string deploymentID
    )
    ...
    public virtual bool Equals(DeploymentArchiveParams? other)
    {
        if (other == null)
        {
            return false;
