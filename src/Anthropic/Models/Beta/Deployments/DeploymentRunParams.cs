...
/// </summary>
public record class DeploymentRunParams : ParamsBase
{
    ...
    public DeploymentRunParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DeploymentRunParams(DeploymentRunParams deploymentRunParams)
        : base(deploymentRunParams)
    {
        this.DeploymentID = deploymentRunParams.DeploymentID;
    }
...
#pragma warning restore CS8618
    ...
    public static DeploymentRunParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string deploymentID
    )
    ...
    public virtual bool Equals(DeploymentRunParams? other)
    {
        if (other == null)
        {
            return false;
