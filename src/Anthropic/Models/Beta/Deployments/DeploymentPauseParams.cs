...
/// </summary>
public record class DeploymentPauseParams : ParamsBase
{
    ...
    public DeploymentPauseParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DeploymentPauseParams(DeploymentPauseParams deploymentPauseParams)
        : base(deploymentPauseParams)
    {
        this.DeploymentID = deploymentPauseParams.DeploymentID;
    }
...
#pragma warning restore CS8618
    ...
    public static DeploymentPauseParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string deploymentID
    )
    ...
    public virtual bool Equals(DeploymentPauseParams? other)
    {
        if (other == null)
        {
            return false;
