...
/// </summary>
public record class MemoryStoreRetrieveParams : ParamsBase
{
    ...
    public MemoryStoreRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MemoryStoreRetrieveParams(MemoryStoreRetrieveParams memoryStoreRetrieveParams)
        : base(memoryStoreRetrieveParams)
    {
        this.MemoryStoreID = memoryStoreRetrieveParams.MemoryStoreID;
    }
...
#pragma warning restore CS8618
    ...
    public static MemoryStoreRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string memoryStoreID
    )
    ...
    public virtual bool Equals(MemoryStoreRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
