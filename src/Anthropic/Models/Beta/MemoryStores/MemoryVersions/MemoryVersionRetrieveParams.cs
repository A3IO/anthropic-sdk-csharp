...
/// </summary>
public record class MemoryVersionRetrieveParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MemoryVersionRetrieveParams(MemoryVersionRetrieveParams memoryVersionRetrieveParams)
        : base(memoryVersionRetrieveParams)
    {
        this.MemoryStoreID = memoryVersionRetrieveParams.MemoryStoreID;
        this.MemoryVersionID = memoryVersionRetrieveParams.MemoryVersionID;
    }
...
#pragma warning restore CS8618
    ...
    public static MemoryVersionRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string memoryStoreID,
        string memoryVersionID
    ...
    public virtual bool Equals(MemoryVersionRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
