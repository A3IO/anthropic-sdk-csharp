...
/// </summary>
public record class MemoryStoreDeleteParams : ParamsBase
{
    ...
    public MemoryStoreDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MemoryStoreDeleteParams(MemoryStoreDeleteParams memoryStoreDeleteParams)
        : base(memoryStoreDeleteParams)
    {
        this.MemoryStoreID = memoryStoreDeleteParams.MemoryStoreID;
    }
...
#pragma warning restore CS8618
    ...
    public static MemoryStoreDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string memoryStoreID
    )
    ...
    public virtual bool Equals(MemoryStoreDeleteParams? other)
    {
        if (other == null)
        {
            return false;
