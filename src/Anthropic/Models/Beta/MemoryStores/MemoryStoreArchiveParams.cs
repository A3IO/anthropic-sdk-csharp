...
/// </summary>
public record class MemoryStoreArchiveParams : ParamsBase
{
    ...
    public MemoryStoreArchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MemoryStoreArchiveParams(MemoryStoreArchiveParams memoryStoreArchiveParams)
        : base(memoryStoreArchiveParams)
    {
        this.MemoryStoreID = memoryStoreArchiveParams.MemoryStoreID;
    }
...
#pragma warning restore CS8618
    ...
    public static MemoryStoreArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string memoryStoreID
    )
    ...
    public virtual bool Equals(MemoryStoreArchiveParams? other)
    {
        if (other == null)
        {
            return false;
