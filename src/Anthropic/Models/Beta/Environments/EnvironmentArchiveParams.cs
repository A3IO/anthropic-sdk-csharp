...
/// <summary>
/// Archive an environment by ID. Archived environments cannot be used to create
/// new sessions.
///
...
/// </summary>
public record class EnvironmentArchiveParams : ParamsBase
{
    ...
    public EnvironmentArchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public EnvironmentArchiveParams(EnvironmentArchiveParams environmentArchiveParams)
        : base(environmentArchiveParams)
    {
        this.EnvironmentID = environmentArchiveParams.EnvironmentID;
    }
...
#pragma warning restore CS8618
    ...
    public static EnvironmentArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string environmentID
    )
    ...
    public virtual bool Equals(EnvironmentArchiveParams? other)
    {
        if (other == null)
        {
            return false;
