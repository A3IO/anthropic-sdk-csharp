...
/// </summary>
public record class WorkStopParams : ParamsBase
{
    ...
    public bool? Force
    {
        get
        {
            ...
            return this._rawBodyData.GetNullableStruct<bool>("force");
        }
        init
        {
            if (value == null)
            ...
            this._rawBodyData.Set("force", value);
        }
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WorkStopParams(WorkStopParams workStopParams)
        : base(workStopParams)
    {
        this.EnvironmentID = workStopParams.EnvironmentID;
        this.WorkID = workStopParams.WorkID;

        this._rawBodyData = new(workStopParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static WorkStopParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string environmentID,
    ...
    public virtual bool Equals(WorkStopParams? other)
    {
        if (other == null)
        {
            return false;
