...
/// </summary>
public record class WorkStatsParams : ParamsBase
{
    ...
    public WorkStatsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WorkStatsParams(WorkStatsParams workStatsParams)
        : base(workStatsParams)
    {
        this.EnvironmentID = workStatsParams.EnvironmentID;
    }
...
#pragma warning restore CS8618
    ...
    public static WorkStatsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string environmentID
    )
    ...
    public virtual bool Equals(WorkStatsParams? other)
    {
        if (other == null)
        {
            return false;
