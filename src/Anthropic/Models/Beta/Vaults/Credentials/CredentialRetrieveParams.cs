...
/// </summary>
public record class CredentialRetrieveParams : ParamsBase
{
    ...
    public CredentialRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CredentialRetrieveParams(CredentialRetrieveParams credentialRetrieveParams)
        : base(credentialRetrieveParams)
    {
        this.VaultID = credentialRetrieveParams.VaultID;
        this.CredentialID = credentialRetrieveParams.CredentialID;
    }
...
#pragma warning restore CS8618
    ...
    public static CredentialRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string vaultID,
        string credentialID
    ...
    public virtual bool Equals(CredentialRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
