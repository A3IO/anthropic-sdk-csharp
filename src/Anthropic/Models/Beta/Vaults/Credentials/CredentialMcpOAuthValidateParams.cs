...
/// </summary>
public record class CredentialMcpOAuthValidateParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CredentialMcpOAuthValidateParams(
        CredentialMcpOAuthValidateParams credentialMcpOAuthValidateParams
    )
        : base(credentialMcpOAuthValidateParams)
    {
        this.VaultID = credentialMcpOAuthValidateParams.VaultID;
        this.CredentialID = credentialMcpOAuthValidateParams.CredentialID;
    }
...
#pragma warning restore CS8618
    ...
    public static CredentialMcpOAuthValidateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string vaultID,
        string credentialID
    ...
    public virtual bool Equals(CredentialMcpOAuthValidateParams? other)
    {
        if (other == null)
        {
            return false;
