...
/// </summary>
public record class CredentialDeleteParams : ParamsBase
{
    ...
    public CredentialDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CredentialDeleteParams(CredentialDeleteParams credentialDeleteParams)
        : base(credentialDeleteParams)
    {
        this.VaultID = credentialDeleteParams.VaultID;
        this.CredentialID = credentialDeleteParams.CredentialID;
    }
...
#pragma warning restore CS8618
    ...
    public static CredentialDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string vaultID,
        string credentialID
    ...
    public virtual bool Equals(CredentialDeleteParams? other)
    {
        if (other == null)
        {
            return false;
