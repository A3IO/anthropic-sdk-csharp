...
/// </summary>
public record class VaultArchiveParams : ParamsBase
{
    ...
    public VaultArchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public VaultArchiveParams(VaultArchiveParams vaultArchiveParams)
        : base(vaultArchiveParams)
    {
        this.VaultID = vaultArchiveParams.VaultID;
    }
...
#pragma warning restore CS8618
    ...
    public static VaultArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string vaultID
    )
    ...
    public virtual bool Equals(VaultArchiveParams? other)
    {
        if (other == null)
        {
            return false;
