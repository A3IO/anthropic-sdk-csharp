...
/// </summary>
public record class VaultDeleteParams : ParamsBase
{
    ...
    public VaultDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public VaultDeleteParams(VaultDeleteParams vaultDeleteParams)
        : base(vaultDeleteParams)
    {
        this.VaultID = vaultDeleteParams.VaultID;
    }
...
#pragma warning restore CS8618
    ...
    public static VaultDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string vaultID
    )
    ...
    public virtual bool Equals(VaultDeleteParams? other)
    {
        if (other == null)
        {
            return false;
