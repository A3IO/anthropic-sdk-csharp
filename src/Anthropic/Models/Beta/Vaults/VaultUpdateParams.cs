...
/// </summary>
public record class VaultUpdateParams : ParamsBase
{
    ...
    public VaultUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public VaultUpdateParams(VaultUpdateParams vaultUpdateParams)
        : base(vaultUpdateParams)
    {
        this.VaultID = vaultUpdateParams.VaultID;

        this._rawBodyData = new(vaultUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static VaultUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string vaultID
    ...
    public virtual bool Equals(VaultUpdateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    internal override void AddHeadersToRequest(HttpRequestMessage request, ClientOptions options)
    {
        ...
        VaultService.AddDefaultHeaders(request);
