...
/// </summary>
public record class UserProfileRetrieveParams : ParamsBase
{
    ...
    public UserProfileRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public UserProfileRetrieveParams(UserProfileRetrieveParams userProfileRetrieveParams)
        : base(userProfileRetrieveParams)
    {
        this.UserProfileID = userProfileRetrieveParams.UserProfileID;
    }
...
#pragma warning restore CS8618
    ...
    public static UserProfileRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string userProfileID
    )
    ...
    public virtual bool Equals(UserProfileRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
