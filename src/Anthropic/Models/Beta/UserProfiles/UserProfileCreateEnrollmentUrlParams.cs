...
/// </summary>
public record class UserProfileCreateEnrollmentUrlParams : ParamsBase
{
    ...
    public UserProfileCreateEnrollmentUrlParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public UserProfileCreateEnrollmentUrlParams(
        UserProfileCreateEnrollmentUrlParams userProfileCreateEnrollmentUrlParams
    )
        : base(userProfileCreateEnrollmentUrlParams)
    {
        this.UserProfileID = userProfileCreateEnrollmentUrlParams.UserProfileID;
    }
...
#pragma warning restore CS8618
    ...
    public static UserProfileCreateEnrollmentUrlParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string userProfileID
    )
    ...
    public virtual bool Equals(UserProfileCreateEnrollmentUrlParams? other)
    {
        if (other == null)
        {
            return false;
