...
/// </summary>
public record class AgentArchiveParams : ParamsBase
{
    ...
    public AgentArchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AgentArchiveParams(AgentArchiveParams agentArchiveParams)
        : base(agentArchiveParams)
    {
        this.AgentID = agentArchiveParams.AgentID;
    }
...
#pragma warning restore CS8618
    ...
    public static AgentArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string agentID
    )
    ...
    public virtual bool Equals(AgentArchiveParams? other)
    {
        if (other == null)
        {
            return false;
