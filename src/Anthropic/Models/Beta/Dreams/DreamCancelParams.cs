...
/// </summary>
public record class DreamCancelParams : ParamsBase
{
    ...
    public DreamCancelParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DreamCancelParams(DreamCancelParams dreamCancelParams)
        : base(dreamCancelParams)
    {
        this.DreamID = dreamCancelParams.DreamID;
    }
...
#pragma warning restore CS8618
    ...
    public static DreamCancelParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string dreamID
    )
    ...
    public virtual bool Equals(DreamCancelParams? other)
    {
        if (other == null)
        {
            return false;
