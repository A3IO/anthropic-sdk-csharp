...
/// </summary>
public record class DreamRetrieveParams : ParamsBase
{
    ...
    public DreamRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DreamRetrieveParams(DreamRetrieveParams dreamRetrieveParams)
        : base(dreamRetrieveParams)
    {
        this.DreamID = dreamRetrieveParams.DreamID;
    }
...
#pragma warning restore CS8618
    ...
    public static DreamRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string dreamID
    )
    ...
    public virtual bool Equals(DreamRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
