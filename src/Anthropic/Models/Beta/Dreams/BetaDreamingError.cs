...
[JsonConverter(typeof(BetaDreamingErrorConverter))]
public record class BetaDreamingError : ModelBase
{
    ...
    public string? Message
    {
        get
        {
            return this.Value switch
            {
                ...
                BetaTargetStoreHeldError x => x.Message,
    ...
    public JsonElement Type
    {
        get
        {
            return this.Value switch
            {
                ...
                BetaTargetStoreHeldError x => x.Type,
                _ => WrappedJsonSerializer.GetNotNullStructProperty<JsonElement>(this.Json, "type"),
            };
        }
    }

    public BetaDreamingError(BetaInvalidRequestError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaAuthenticationError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaBillingError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaPermissionError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaNotFoundError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaRateLimitError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaGatewayTimeoutError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaApiError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaOverloadedError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(BetaTargetStoreHeldError value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaDreamingError(JsonElement element)
    {
        this._element = element;
    }
    ...
    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="BetaTargetStoreHeldError"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    /// <code>
    /// if (instance.TryPickTargetStoreHeld(out var value)) {
    ///     // `value` is of type `BetaTargetStoreHeldError`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    /// </summary>
    public bool TryPickTargetStoreHeld([NotNullWhen(true)] out BetaTargetStoreHeldError? value)
    {
        value = this.Value as BetaTargetStoreHeldError;
        return value != null;
    }
    ...
    ///     (BetaTargetStoreHeldError value) =&gt; {...}
    /// );
    /// </code>
    /// </example>
    /// </summary>
    public void Switch(
        System::Action<BetaInvalidRequestError> invalidRequest,
        System::Action<BetaAuthenticationError> authentication,
        System::Action<BetaBillingError> billing,
        System::Action<BetaPermissionError> permission,
        System::Action<BetaNotFoundError> notFound,
        System::Action<BetaRateLimitError> rateLimit,
        System::Action<BetaGatewayTimeoutError> gatewayTimeout,
        System::Action<BetaApiError> api,
        System::Action<BetaOverloadedError> overloaded,
        System::Action<BetaTargetStoreHeldError> targetStoreHeld
    )
    {
        switch (this.Value)
        {
            ...
            case BetaOverloadedError value:
                overloaded(value);
                break;
            case BetaTargetStoreHeldError value:
                targetStoreHeld(value);
                break;
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaDreamingError"
                );
        }
    }
    ...
    /// </summary>
    public T Match<T>(
        System::Func<BetaInvalidRequestError, T> invalidRequest,
        System::Func<BetaAuthenticationError, T> authentication,
        System::Func<BetaBillingError, T> billing,
        System::Func<BetaPermissionError, T> permission,
        System::Func<BetaNotFoundError, T> notFound,
        System::Func<BetaRateLimitError, T> rateLimit,
        System::Func<BetaGatewayTimeoutError, T> gatewayTimeout,
        System::Func<BetaApiError, T> api,
        System::Func<BetaOverloadedError, T> overloaded,
        System::Func<BetaTargetStoreHeldError, T> targetStoreHeld
    )
    {
        return this.Value switch
        {
            ...
            BetaTargetStoreHeldError value => targetStoreHeld(value),
    ...
    public static implicit operator BetaDreamingError(BetaInvalidRequestError value) => new(value);

    public static implicit operator BetaDreamingError(BetaAuthenticationError value) => new(value);

    public static implicit operator BetaDreamingError(BetaBillingError value) => new(value);

    public static implicit operator BetaDreamingError(BetaPermissionError value) => new(value);

    public static implicit operator BetaDreamingError(BetaNotFoundError value) => new(value);

    public static implicit operator BetaDreamingError(BetaRateLimitError value) => new(value);

    public static implicit operator BetaDreamingError(BetaGatewayTimeoutError value) => new(value);

    public static implicit operator BetaDreamingError(BetaApiError value) => new(value);

    public static implicit operator BetaDreamingError(BetaOverloadedError value) => new(value);

    public static implicit operator BetaDreamingError(BetaTargetStoreHeldError value) => new(value);
    ...
    public override void Validate()
    {
        ...
        this.Switch(
            ...
            (targetStoreHeld) => targetStoreHeld.Validate()
        );
    }

    public virtual bool Equals(BetaDreamingError? other) =>
        other != null
    ...
    int VariantIndex()
    {
        return this.Value switch
        {
            ...
            BetaTargetStoreHeldError _ => 9,
            _ => -1,
        };
    }
}

sealed class BetaDreamingErrorConverter : JsonConverter<BetaDreamingError>
{
    public override BetaDreamingError? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaDreamingError(element);
            }
        }
    }
