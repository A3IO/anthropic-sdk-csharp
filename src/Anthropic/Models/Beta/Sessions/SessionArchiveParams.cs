...
/// </summary>
public record class SessionArchiveParams : ParamsBase
{
    ...
    public SessionArchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SessionArchiveParams(SessionArchiveParams sessionArchiveParams)
        : base(sessionArchiveParams)
    {
        this.SessionID = sessionArchiveParams.SessionID;
    }
...
#pragma warning restore CS8618
    ...
    public static SessionArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string sessionID
    )
    ...
    public virtual bool Equals(SessionArchiveParams? other)
    {
        if (other == null)
        {
            return false;
