...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsUserCustomToolResultEventFromRaw
    >)
)]
public sealed record class BetaManagedAgentsUserCustomToolResultEvent : JsonModel
{
    /// <summary>
    ...
    public required ApiEnum<string, BetaManagedAgentsUserCustomToolResultEventType> Type
    {
        get
        {
            this._rawData.Freeze();
    ...
    /// </summary>
    public IReadOnlyList<BetaManagedAgentsUserCustomToolResultEventContent>? Content
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<
                ImmutableArray<BetaManagedAgentsUserCustomToolResultEventContent>
            >("content");
        }
        init
        {
            ...
            this._rawData.Set<ImmutableArray<BetaManagedAgentsUserCustomToolResultEventContent>?>(
                "content",
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsUserCustomToolResultEvent(
        BetaManagedAgentsUserCustomToolResultEvent betaManagedAgentsUserCustomToolResultEvent
    )
        : base(betaManagedAgentsUserCustomToolResultEvent) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsUserCustomToolResultEvent(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsUserCustomToolResultEventFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsUserCustomToolResultEvent FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsUserCustomToolResultEventFromRaw
    : IFromRawJson<BetaManagedAgentsUserCustomToolResultEvent>
{
    /// <inheritdoc/>
    public BetaManagedAgentsUserCustomToolResultEvent FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsUserCustomToolResultEvent.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(BetaManagedAgentsUserCustomToolResultEventTypeConverter))]
public enum BetaManagedAgentsUserCustomToolResultEventType
{
    UserCustomToolResult,
}

sealed class BetaManagedAgentsUserCustomToolResultEventTypeConverter
    : JsonConverter<BetaManagedAgentsUserCustomToolResultEventType>
{
    public override BetaManagedAgentsUserCustomToolResultEventType Read(
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            _ => (BetaManagedAgentsUserCustomToolResultEventType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        BetaManagedAgentsUserCustomToolResultEventType value,
        JsonSerializerOptions options
    )
    {
...
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsUserCustomToolResultEventContentConverter))]
public record class BetaManagedAgentsUserCustomToolResultEventContent : ModelBase
{
    ...
    public BetaManagedAgentsUserCustomToolResultEventContent(
    ...
    public BetaManagedAgentsUserCustomToolResultEventContent(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsUserCustomToolResultEventContent"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsUserCustomToolResultEventContent(
        BetaManagedAgentsTextBlock value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsUserCustomToolResultEventContent? other) =>
        other != null
...
sealed class BetaManagedAgentsUserCustomToolResultEventContentConverter
    : JsonConverter<BetaManagedAgentsUserCustomToolResultEventContent>
{
    public override BetaManagedAgentsUserCustomToolResultEventContent? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsUserCustomToolResultEventContent(element);
            }
        }
    }
