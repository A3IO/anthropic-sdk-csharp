...
/// </summary>
public record class SessionDeleteParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SessionDeleteParams(SessionDeleteParams sessionDeleteParams)
        : base(sessionDeleteParams)
    {
        this.SessionID = sessionDeleteParams.SessionID;
    }
...
#pragma warning restore CS8618
    ...
    public static SessionDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string sessionID
    )
    ...
    public virtual bool Equals(SessionDeleteParams? other)
    {
        if (other == null)
        {
            return false;
