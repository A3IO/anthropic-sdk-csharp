...
/// </summary>
public record class ResourceUpdateParams : ParamsBase
{
    ...
    public required string AuthorizationToken
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<string>("authorization_token");
        }
        init { this._rawBodyData.Set("authorization_token", value); }
    }
    ...
    public ResourceUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ResourceUpdateParams(ResourceUpdateParams resourceUpdateParams)
        : base(resourceUpdateParams)
    {
        this.SessionID = resourceUpdateParams.SessionID;
        this.ResourceID = resourceUpdateParams.ResourceID;

        this._rawBodyData = new(resourceUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ResourceUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string sessionID,
        ...
        JsonSerializer.Serialize(
            FriendlyJsonPrinter.PrintValue(
                new Dictionary<string, JsonElement>()
                {
                    ...
                    ["ResourceID"] = JsonSerializer.SerializeToElement(this.ResourceID),
    ...
    public virtual bool Equals(ResourceUpdateParams? other)
    {
        if (other == null)
        {
            return false;
        ...
        return this.SessionID.Equals(other.SessionID)
            && (this.ResourceID?.Equals(other.ResourceID) ?? other.ResourceID == null)
