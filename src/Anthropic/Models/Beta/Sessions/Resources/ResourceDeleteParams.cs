...
/// </summary>
public record class ResourceDeleteParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ResourceDeleteParams(ResourceDeleteParams resourceDeleteParams)
        : base(resourceDeleteParams)
    {
        this.SessionID = resourceDeleteParams.SessionID;
        this.ResourceID = resourceDeleteParams.ResourceID;
    }
...
#pragma warning restore CS8618
    ...
    public static ResourceDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string sessionID,
        string resourceID
    ...
    public virtual bool Equals(ResourceDeleteParams? other)
    {
        if (other == null)
        {
            return false;
