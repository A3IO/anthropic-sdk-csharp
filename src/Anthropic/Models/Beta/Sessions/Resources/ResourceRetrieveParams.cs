...
/// </summary>
public record class ResourceRetrieveParams : ParamsBase
{
    ...
    public ResourceRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ResourceRetrieveParams(ResourceRetrieveParams resourceRetrieveParams)
        : base(resourceRetrieveParams)
    {
        this.SessionID = resourceRetrieveParams.SessionID;
        this.ResourceID = resourceRetrieveParams.ResourceID;
    }
...
#pragma warning restore CS8618
    ...
    public static ResourceRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string sessionID,
        string resourceID
    ...
    public virtual bool Equals(ResourceRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
