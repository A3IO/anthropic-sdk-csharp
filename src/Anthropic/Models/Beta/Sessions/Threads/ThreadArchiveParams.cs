...
/// </summary>
public record class ThreadArchiveParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ThreadArchiveParams(ThreadArchiveParams threadArchiveParams)
        : base(threadArchiveParams)
    {
        this.SessionID = threadArchiveParams.SessionID;
        this.ThreadID = threadArchiveParams.ThreadID;
    }
...
#pragma warning restore CS8618
    ...
    public static ThreadArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string sessionID,
        string threadID
    ...
    public virtual bool Equals(ThreadArchiveParams? other)
    {
        if (other == null)
        {
            return false;
