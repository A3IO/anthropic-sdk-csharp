...
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsStreamSessionThreadEventsConverter))]
public record class BetaManagedAgentsStreamSessionThreadEvents : ModelBase
{
    ...
    public BetaManagedAgentsStreamSessionThreadEvents(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsStreamSessionThreadEvents"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsStreamSessionThreadEvents(
        BetaManagedAgentsUserMessageEvent value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsStreamSessionThreadEvents? other) =>
        other != null
...
sealed class BetaManagedAgentsStreamSessionThreadEventsConverter
    : JsonConverter<BetaManagedAgentsStreamSessionThreadEvents>
{
    public override BetaManagedAgentsStreamSessionThreadEvents? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsStreamSessionThreadEvents(element);
            }
        }
    }
