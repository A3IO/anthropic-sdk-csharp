...
/// </summary>
public record class TunnelRotateTokenParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TunnelRotateTokenParams(TunnelRotateTokenParams tunnelRotateTokenParams)
        : base(tunnelRotateTokenParams)
    {
        this.TunnelID = tunnelRotateTokenParams.TunnelID;

        this._rawBodyData = new(tunnelRotateTokenParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static TunnelRotateTokenParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string tunnelID
    ...
    public virtual bool Equals(TunnelRotateTokenParams? other)
    {
        if (other == null)
        {
            return false;
