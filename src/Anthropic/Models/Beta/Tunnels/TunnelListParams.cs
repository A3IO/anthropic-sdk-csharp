...
///
/// <para>Lists tunnels. Results are ordered by creation time, newest first; archived
/// tunnels are excluded unless include_archived is set.</para>
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class TunnelListParams : ParamsBase
{
    /// <summary>
    ...
    public TunnelListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TunnelListParams(TunnelListParams tunnelListParams)
        : base(tunnelListParams) { }
...
#pragma warning restore CS8618
    ...
    public static TunnelListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TunnelListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        ...
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/tunnels")
        {
