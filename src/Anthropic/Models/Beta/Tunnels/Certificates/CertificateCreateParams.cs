...
///
/// <para>Registers a public CA certificate on a tunnel. Anthropic verifies the gateway's
/// server certificate against this CA when it terminates the inner TLS session.
/// A tunnel holds at most two non-archived certificates.</para>
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class CertificateCreateParams : ParamsBase
{
    ...
    public required string CACertificatePem
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<string>("ca_certificate_pem");
        }
        init { this._rawBodyData.Set("ca_certificate_pem", value); }
    }
    ...
    public CertificateCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CertificateCreateParams(CertificateCreateParams certificateCreateParams)
        : base(certificateCreateParams)
    {
        this.TunnelID = certificateCreateParams.TunnelID;

        this._rawBodyData = new(certificateCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static CertificateCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string tunnelID
    ...
    public virtual bool Equals(CertificateCreateParams? other)
    {
        if (other == null)
        {
            return false;
