...
/// </summary>
public record class CertificateListParams : ParamsBase
{
    ...
    public CertificateListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CertificateListParams(CertificateListParams certificateListParams)
        : base(certificateListParams)
    {
        this.TunnelID = certificateListParams.TunnelID;
    }
...
#pragma warning restore CS8618
    ...
    public static CertificateListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string tunnelID
    )
    ...
    public virtual bool Equals(CertificateListParams? other)
    {
        if (other == null)
        {
            return false;
