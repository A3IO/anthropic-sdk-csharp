...
/// </summary>
public record class CertificateRetrieveParams : ParamsBase
{
    ...
    public CertificateRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CertificateRetrieveParams(CertificateRetrieveParams certificateRetrieveParams)
        : base(certificateRetrieveParams)
    {
        this.TunnelID = certificateRetrieveParams.TunnelID;
        this.CertificateID = certificateRetrieveParams.CertificateID;
    }
...
#pragma warning restore CS8618
    ...
    public static CertificateRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string tunnelID,
        string certificateID
    ...
    public virtual bool Equals(CertificateRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
