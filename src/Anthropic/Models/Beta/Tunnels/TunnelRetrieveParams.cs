...
/// </summary>
public record class TunnelRetrieveParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TunnelRetrieveParams(TunnelRetrieveParams tunnelRetrieveParams)
        : base(tunnelRetrieveParams)
    {
        this.TunnelID = tunnelRetrieveParams.TunnelID;
    }
...
#pragma warning restore CS8618
    ...
    public static TunnelRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string tunnelID
    )
    ...
    public virtual bool Equals(TunnelRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
