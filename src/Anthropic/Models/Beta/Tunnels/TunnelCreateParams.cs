...
/// </summary>
public record class TunnelCreateParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TunnelCreateParams(TunnelCreateParams tunnelCreateParams)
        : base(tunnelCreateParams)
    {
        this._rawBodyData = new(tunnelCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static TunnelCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(TunnelCreateParams? other)
    {
        if (other == null)
        {
            return false;
