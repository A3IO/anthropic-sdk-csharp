...
///
/// <para>Archives a tunnel. Archival is irreversible: every non-archived certificate
/// on the tunnel is archived in the same operation, the hostname is retired and never
/// re-allocated, and the tunnel token is invalidated. Retrying against an already-archived
/// tunnel returns the existing record unchanged.</para>
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class TunnelArchiveParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TunnelArchiveParams(TunnelArchiveParams tunnelArchiveParams)
        : base(tunnelArchiveParams)
    {
        this.TunnelID = tunnelArchiveParams.TunnelID;
    }
...
#pragma warning restore CS8618
    ...
    public static TunnelArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string tunnelID
    )
    ...
    public virtual bool Equals(TunnelArchiveParams? other)
    {
        if (other == null)
        {
            return false;
