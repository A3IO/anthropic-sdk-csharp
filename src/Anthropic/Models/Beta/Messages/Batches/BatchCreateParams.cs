...
public sealed record class Params : JsonModel
{
    ...
    public FallbackCreditToken? FallbackCreditToken
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<FallbackCreditToken>("fallback_credit_token");
        }
    ...
    public BetaFallbacksParam? Fallbacks
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<BetaFallbacksParam>("fallbacks");
        }
        init { this._rawData.Set("fallbacks", value); }
    }
    ...
    public override void Validate()
    {
        ...
        this.FallbackCreditToken?.Validate();
        this.Fallbacks?.Validate();
        _ = this.InferenceGeo;
