...
public sealed record class BetaWebSearchToolResultBlock : JsonModel
{
    ...
    public BetaWebSearchToolResultBlockCaller? Caller
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<BetaWebSearchToolResultBlockCaller>("caller");
        }
        init
        {
            if (value == null)
...
public record class BetaWebSearchToolResultBlockCaller : ModelBase
{
    ...
    public BetaWebSearchToolResultBlockCaller(BetaDirectCaller value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public BetaWebSearchToolResultBlockCaller(
    ...
    public BetaWebSearchToolResultBlockCaller(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaWebSearchToolResultBlockCaller"
                );
        }
    }
    ...
    public static implicit operator BetaWebSearchToolResultBlockCaller(BetaDirectCaller value) =>
        new(value);

    public static implicit operator BetaWebSearchToolResultBlockCaller(
        BetaServerToolCaller value
    ) => new(value);
    ...
    public virtual bool Equals(BetaWebSearchToolResultBlockCaller? other) =>
        other != null
...
sealed class BetaWebSearchToolResultBlockCallerConverter
    : JsonConverter<BetaWebSearchToolResultBlockCaller>
{
    public override BetaWebSearchToolResultBlockCaller? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaWebSearchToolResultBlockCaller(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        BetaWebSearchToolResultBlockCaller value,
        JsonSerializerOptions options
    )
    {
