...
public class BetaCompactionConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaCompactionConfig { Instructions = "instructions" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaCompactionConfig>(
            json,
    ...
    {
        var model = new BetaCompactionConfig { };
    ...
    {
        var model = new BetaCompactionConfig { Instructions = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaCompactionConfig copied = new(model);
