...
public class WebFetchTool20260318Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WebFetchTool20260318
        {
        ...
        List<ApiEnum<string, WebFetchTool20260318AllowedCaller>> expectedAllowedCallers =
        [
            WebFetchTool20260318AllowedCaller.Direct,
        ];
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<WebFetchTool20260318>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        WebFetchTool20260318 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class WebFetchTool20260318AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(WebFetchTool20260318AllowedCaller.Direct)]
    [InlineData(WebFetchTool20260318AllowedCaller.CodeExecution20250825)]
    [InlineData(WebFetchTool20260318AllowedCaller.CodeExecution20260120)]
    [InlineData(WebFetchTool20260318AllowedCaller.CodeExecution20260521)]
    public void Validation_Works(WebFetchTool20260318AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WebFetchTool20260318AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, WebFetchTool20260318AllowedCaller>>(
    ...
    [InlineData(WebFetchTool20260318AllowedCaller.CodeExecution20260120)]
    [InlineData(WebFetchTool20260318AllowedCaller.CodeExecution20260521)]
    public void SerializationRoundtrip_Works(WebFetchTool20260318AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WebFetchTool20260318AllowedCaller> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, WebFetchTool20260318AllowedCaller>
