...
public class WebFetchTool20250910Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WebFetchTool20250910
        {
        ...
        List<ApiEnum<string, WebFetchTool20250910AllowedCaller>> expectedAllowedCallers =
        [
            WebFetchTool20250910AllowedCaller.Direct,
        ];
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<WebFetchTool20250910>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        WebFetchTool20250910 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class WebFetchTool20250910AllowedCallerTest : TestBase
{
    [Theory]
    ...
    [InlineData(WebFetchTool20250910AllowedCaller.CodeExecution20260521)]
    public void Validation_Works(WebFetchTool20250910AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WebFetchTool20250910AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, WebFetchTool20250910AllowedCaller>>(
    ...
    public void SerializationRoundtrip_Works(WebFetchTool20250910AllowedCaller rawValue)
    {
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, WebFetchTool20250910AllowedCaller>
